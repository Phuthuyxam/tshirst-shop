...
<div class="main-wrapper">
    <div class="container custom-container">
        ...
        <div class="recommend-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-3 col-2/3">
                        <div class="item-wrapper">
                            <a href="#">
                                <div class="item-thumb">
                                    <img src="images/medium1.jpg" alt="">
                                </div>
                                <div class="item-content">
                                    <div class="item-title">
                                        <h3 class="fs-sm">SKULL MOUSEPAD BEST GIFT ZD04</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-3 col-2/3">
                        <div class="item-wrapper">
                            <a href="#">
                                <div class="item-thumb">
                                    <img src="images/medium2.jpg" alt="">
                                </div>
                                <div class="item-content">
                                    <div class="item-title">
                                        <h3 class="fs-sm">SKULL MOUSEPAD BEST GIFT ZD04</h3>
                            ...
                            <a href="#">
                                <div class="cate-wrapper">
                                    <div class="cate-thumb">
                                        <img src="images/thumb.jpg" alt="" srcset="">
                                    </div>
            ...
            <div class="products-wrapper type1" style="background-image: url(images/tumb1.jpg);">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-sm-12">
                        <a href="#">
                            <div class="product-banner-wrapper">
                                <img src="images/tumb1.jpg" class="d-sm-none d-lg-block d-xl-block d-none" alt="">
            ...
            <div class="products-wrapper type2" style="background-image: url(images/tumb22.jpg);">
                <div class="row">
                    <div class="col-12">
                        <a href="#">
                            <div class="product-banner-wrapper">
                                <img src="images/tumb2.jpg" class="d-sm-none d-lg-block d-xl-block d-none" alt="">
                                <div class="product-banner-title">
            ...
            <div class="products-wrapper type3" style="background-image: url(images/tumb33.jpg);">
                <div class="row">
