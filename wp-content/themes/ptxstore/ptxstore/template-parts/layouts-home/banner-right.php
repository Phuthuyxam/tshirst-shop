<div class="products-wrapper type3" style="background-image: url(<?php echo $productData['add_banner'] ?>);">
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 d-sm-none d-lg-block d-xl-block d-none">
            <a href="<?php echo $productData['link_banner'] ?>">
                <div class="product-banner-wrapper">
                    <img src="<?php echo $productData['add_banner'] ?>" class="d-sm-none d-lg-block d-xl-block d-none" alt="banner home right">
                    <div class="product-banner-title">
                        <h2 class="fs-3xl fw-extraBold"><?php echo $productData['banner_title'] ?></h2>
