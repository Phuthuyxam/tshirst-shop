<div class="products-wrapper type1" style="background-image: url(<?php echo $productData['add_banner'] ?>);">
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-sm-12">
            <a href="<?php echo $productData['link_banner'] ?>">
                <div class="product-banner-wrapper">
                    <img src="<?php echo $productData['add_banner'] ?>" class="d-sm-none d-lg-block d-xl-block d-none" alt="banner home left">
